...
#nohup python "$HOME"/my_env/s1/tw_aws_s1.py & # Uncomment as required
...
#nohup python "$HOME"/my_env/s2/tw_aws_s2.py & # Uncomment as required
...
#nohup python "$HOME"/my_env/s3/tw_aws_s3.py & # Uncomment as required
...
#nohup python "$HOME"/my_env/s4/tw_aws_s4.py & # Uncomment as required
...
#nohup python "$HOME"/my_env/s5/tw_aws_s5.py & # Uncomment as required
...
#nohup python "$HOME"/my_env/s6/tw_aws_s6.py & # Uncomment as required
...
#nohup python "$HOME"/my_env/s7/tw_aws_s7.py & # Uncomment as required
...
#nohup python "$HOME"/my_env/s8/tw_aws_s8.py & # Uncomment as required
...
#nohup python "$HOME"/my_env/s9/tw_aws_s9.py & # Uncomment as required
...
#nohup python "$HOME"/my_env/s10/tw_aws_s10.py & # Uncomment as required
...
#nohup python "$HOME"/my_env/s11/tw_aws_s11.py & # Uncomment as required
...
#nohup python "$HOME"/my_env/s12/tw_aws_s12.py & # Uncomment as required
...
#nohup python "$HOME"/my_env/s13/tw_aws_s13.py & # Uncomment as required
...
#nohup python "$HOME"/my_env/s14/tw_aws_s14.py & # Uncomment as required
...
#nohup python "$HOME"/my_env/s15/tw_aws_s15.py & # Uncomment as required
